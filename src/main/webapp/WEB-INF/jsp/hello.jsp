      ...
      <section class="well well1 well1_ins1">
        ...
        <div class="container center991">
          <div class="row">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<c:url value="/resources/images/page-1_img1.jpg" />" alt="">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<c:url value="/resources/images/page-1_img2.jpg" />" alt="">
          ...
          <div class="row wow fadeIn" data-wow-duration='2s'>
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<c:url value="/resources/images/page-1_img3.jpg" />" alt="">
                <div class="caption bg3">
                  <h3>
                    Expertise
                  </h3>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<c:url value="/resources/images/page-1_img4.jpg" />" alt="">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<c:url value="/resources/images/page-1_img5.jpg" />" alt="">
                <div class="caption bg2">
                  <h3>
                    RESEARCH
                  </h3>
